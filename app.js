...
const fetchTorrentFromHost1 = async (query) => {
  ...
  const url = `${hostUrl}/api/v2.0/indexers/all/results?apikey=${apiKey}&Query=${query}&Category[]=2000&Category[]=5000&Category[]=2040&Category[]=2045&Category[]=2070&Category[]=5040&Category[]=5045&Tracker%5B%5D=knaben`;
