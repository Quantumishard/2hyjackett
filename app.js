...
let fetchTorrent = async (query) => {
  let url = `${host2}/api/v2.0/indexers/all/results?apikey=${apiKey2}&Query=${query}&Category%5B%5D=2000&Category%5B%5D=5000&Tracker%5B%5D=1337x&Tracker%5B%5D=ThePirateBay`;
